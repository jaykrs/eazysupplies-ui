...
import { brandSlider4, categorySlider5, horizontalProductSlider, horizontalProductSlider5 } from "@/data/sliderSetting/SliderSetting";
  ...
  return (
    <>
      ...
      <Container className="no-arrow">
        <section className="category-style-1 section-t-space">
              ...
              {data?.grid_banner?.banners.map((banner, index) => {
                if (banner?.image_url) {
                  if (videoType.includes(banner?.image_url.substring(banner?.image_url.lastIndexOf(".") + 1))) {
                    return (
                      <Col sm="8" className=" p-0" key={index}>
                    ...
                    return (
                      <Col sm="4" className=" p-0" key={index}>

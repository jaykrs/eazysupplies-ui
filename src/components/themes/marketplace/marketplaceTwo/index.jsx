...
import { horizontalProductSlider, horizontalProductSlider5 } from "@/data/sliderSetting/SliderSetting";
  ...
  return (
    <>
      ...
      {data?.products_list_2?.status && (
        <section className="p-0 product-vertical overflow-hidden section-t-space">
